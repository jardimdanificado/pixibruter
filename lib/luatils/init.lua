...
util.math = require "lib.luatils._math"
util.string = require "lib.luatils._string"
util.table = require "lib.luatils._table"
util.array = require "lib.luatils._array"
util.matrix = require "lib.luatils._matrix"
util.file = require "lib.luatils._file"
util.encode = require "lib.luatils._encode"
util.console = require "lib.luatils._console"
